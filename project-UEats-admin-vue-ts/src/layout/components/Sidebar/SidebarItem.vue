    ...
    >
      <template v-if="theOnlyOneChild && !theOnlyOneChild.children">
        ...
        >
          ...
          >
            <!-- <i v-if="theOnlyOneChild.meta.title==='Dashboard'" class="iconfont icon img-icon-sel" /> -->
            <!-- <svg-icon v-if="theOnlyOneChild.meta.title==='Dashboard'" name="dashboard" width="20" height="20"></svg-icon> -->
            <i
