...
export default class extends Vue {
  ...
  private async init(isSearch?: boolean) {
    ...
    await getEmployeeList(params)
      .then((res: any) => {
        ...
        //   this.$message.error('No related employees found, please check if the employee name is correct')
        // }
      })
      .catch((err) => {
  ...
  private statusHandle(row: any) {
    ...
    this.$confirm('Are you sure you want to change the status of this account?', 'Warning', {
