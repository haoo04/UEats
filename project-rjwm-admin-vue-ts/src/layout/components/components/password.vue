    ...
    <el-form :model="form" label-width="85px" :rules="rules" ref="form">
      ...
      <el-form-item label="New Password：" prop="newPassword">
        <el-input
          ...
          type="password"
          placeholder="6 - 20 digits, numbers or letters, case-sensitive"
        ></el-input>
      </el-form-item>
...
export default class extends Vue {
  ...
  private validatePwd = (rule: any, value: any, callback: Function) => {
    ...
    if (!value) {
      ...
      callback(new Error('6 - 20 digits, numbers or letters, case-sensitive'))
    } else {
      callback()
    }
  }
  private validatePass2 = (rule, value, callback) => {
    if (!value) {
      ...
      callback(new Error('Password does not match, please re-enter the password'))
    } else {
      callback()
    }
  }
